      ...
      <div className="flex-1 overflow-y-auto pb-32">
        ...
        <div className="m-4 bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
          <div className="flex justify-between items-end mb-6">
            ...
            <div className="text-center">
              <p className="text-xs text-emerald-500 mb-1 font-bold">
                相手への請求
              </p>
          ...
          <div className="flex justify-between mt-4">
            <button
              type="button"
              onClick={() => setRatio(50)}
              className="px-3 py-1 rounded-full bg-gray-100 text-xs font-bold text-gray-500 hover:bg-gray-200"
            >
              50:50
            </button>
            <button
              type="button"
              className="px-3 py-1 rounded-full bg-emerald-50 text-xs font-bold text-emerald-600 hover:bg-emerald-100"
            >
              端数切上
            </button>
          </div>
              ...
              {[
                ...
                >
                  ...
                  <div className="flex bg-gray-100 rounded-lg p-1">
                    <button
                      type="button"
                      className="px-3 py-1 text-xs font-bold rounded-md bg-white shadow-sm text-emerald-600"
                    >
                      割
                    </button>
                    <button
                      type="button"
                      className="px-3 py-1 text-xs font-bold rounded-md text-gray-400"
                    >
                      自
                    </button>
                    <button
  ...
  const ReceiverScreen = () => (
    <div className="h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        ...
        <button
          type="button"
          className="w-full bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between group hover:border-emerald-200 transition-colors"
        >
      ...
      <div className="p-4 bg-white border-t border-gray-100">
        ...
        <div className="mt-4 text-center">
          <button
            type="button"
            className="text-xs text-gray-400 underline font-medium hover:text-emerald-500"
          >
            PayPayアプリを開く
          </button>
        </div>
